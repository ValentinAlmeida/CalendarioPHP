                                ...
                                <table class="table data-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <button title="Excluir <?php echo $this->router->fetch_class(); ?>" type="button" class="btn btn-icon btn-danger" data-toggle="modal" href="" data-target="#user-<?php echo $user->id; ?>"><i class="ik ik-trash-2"></i></button>
                                        </td>
                                    </tr>
