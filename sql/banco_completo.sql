...
--
-- Host: localhost
-- Tempo de geraÁ„o: 10/07/2019 ‡s 15:13
...
--
-- RestriÁıes para tabelas `convites`
--
ALTER TABLE `convites`
...
--
-- RestriÁıes para tabelas `eventos`
--
ALTER TABLE `eventos`
